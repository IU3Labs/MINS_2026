...
public final class ReferenceServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "autoservice.ReferenceService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.autoservice.proto.ReferenceServiceProto.ServiceRequest,
      com.autoservice.proto.ReferenceServiceProto.ServiceResponse> getGetServiceByNameMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetServiceByName",
      requestType = com.autoservice.proto.ReferenceServiceProto.ServiceRequest.class,
      responseType = com.autoservice.proto.ReferenceServiceProto.ServiceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.autoservice.proto.ReferenceServiceProto.ServiceRequest,
      com.autoservice.proto.ReferenceServiceProto.ServiceResponse> getGetServiceByNameMethod() {
    io.grpc.MethodDescriptor<com.autoservice.proto.ReferenceServiceProto.ServiceRequest, com.autoservice.proto.ReferenceServiceProto.ServiceResponse> getGetServiceByNameMethod;
    if ((getGetServiceByNameMethod = ReferenceServiceGrpc.getGetServiceByNameMethod) == null) {
      synchronized (ReferenceServiceGrpc.class) {
        if ((getGetServiceByNameMethod = ReferenceServiceGrpc.getGetServiceByNameMethod) == null) {
          ReferenceServiceGrpc.getGetServiceByNameMethod = getGetServiceByNameMethod =
              io.grpc.MethodDescriptor.<com.autoservice.proto.ReferenceServiceProto.ServiceRequest, com.autoservice.proto.ReferenceServiceProto.ServiceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetServiceByName"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.autoservice.proto.ReferenceServiceProto.ServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.autoservice.proto.ReferenceServiceProto.ServiceResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ReferenceServiceMethodDescriptorSupplier("GetServiceByName"))
              .build();
        }
      }
    }
    return getGetServiceByNameMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getServiceByName(com.autoservice.proto.ReferenceServiceProto.ServiceRequest request,
        io.grpc.stub.StreamObserver<com.autoservice.proto.ReferenceServiceProto.ServiceResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetServiceByNameMethod(), responseObserver);
    }
  }
  ...
  public static final class ReferenceServiceStub
    ...
    /**
     */
    public void getServiceByName(com.autoservice.proto.ReferenceServiceProto.ServiceRequest request,
        io.grpc.stub.StreamObserver<com.autoservice.proto.ReferenceServiceProto.ServiceResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetServiceByNameMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ReferenceServiceBlockingStub
    ...
    /**
     */
    public com.autoservice.proto.ReferenceServiceProto.ServiceResponse getServiceByName(com.autoservice.proto.ReferenceServiceProto.ServiceRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetServiceByNameMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ReferenceServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.autoservice.proto.ReferenceServiceProto.ServiceResponse> getServiceByName(
        com.autoservice.proto.ReferenceServiceProto.ServiceRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetServiceByNameMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_SERVICE_BY_NAME = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SERVICE_BY_NAME:
          serviceImpl.getServiceByName((com.autoservice.proto.ReferenceServiceProto.ServiceRequest) request,
              (io.grpc.stub.StreamObserver<com.autoservice.proto.ReferenceServiceProto.ServiceResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          getGetServiceByNameMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.autoservice.proto.ReferenceServiceProto.ServiceRequest,
              com.autoservice.proto.ReferenceServiceProto.ServiceResponse>(
                service, METHODID_GET_SERVICE_BY_NAME)))
        .build();
  }
  ...
  private static abstract class ReferenceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.autoservice.proto.ReferenceServiceProto.getDescriptor();
    }
      ...
      synchronized (ReferenceServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetServiceByNameMethod())
              .build();
        }
      }
    }
