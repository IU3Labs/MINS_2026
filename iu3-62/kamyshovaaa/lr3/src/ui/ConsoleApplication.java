...
public class ConsoleApplication {
    ...
    private final RevenuesHandler revenuesHandler;
    ...
    public ConsoleApplication(
            ...
            RevenuesHandler revenuesHandler,
            InputHandler input,
        ...
        this.revenuesHandler = revenuesHandler;
        this.input = input;
    ...
    public void start() {
        while (true) {
            ...
            generalRenderer.printMenu(List.of(
                ...
                new GeneralRenderer.MenuItem("6", "Выручка"),
    ...
    private void runRevenuesMenu() {
        revenuesHandler.handleShowMenu();
    }
}
