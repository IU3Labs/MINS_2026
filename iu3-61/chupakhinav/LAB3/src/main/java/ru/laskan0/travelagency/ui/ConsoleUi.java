...
public class ConsoleUi {
    ...
    private final ExpressTravelCalculatorGodClass expressTravelCalculatorGodClass;
    ...
    public ConsoleUi(
            ...
            Scanner scanner) {
        this(clientService, tourService, bookingService, historyObserver, null, scanner);
    }
    ...
    public ConsoleUi(
            ...
            BookingService bookingService,
            TravelAgencyHistoryObserver historyObserver,
            ExpressTravelCalculatorGodClass expressTravelCalculatorGodClass,
            Scanner scanner) {
        this.clientService = clientService;
        this.tourService = tourService;
        this.bookingService = bookingService;
        this.historyObserver = historyObserver;
        this.expressTravelCalculatorGodClass = expressTravelCalculatorGodClass;
    ...
    private void printMenu() {
        ...
        System.out.println("9. Экспресс-расчет стоимости тура (ЛР3: God Class)");
    ...
    private void runExpressCalculator() {
        if (expressTravelCalculatorGodClass == null) {
            System.out.println("Экспресс-калькулятор не подключен.");
            return;
        }
        expressTravelCalculatorGodClass.launch();
    }
