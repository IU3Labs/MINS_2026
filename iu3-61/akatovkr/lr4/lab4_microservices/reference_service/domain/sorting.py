...
from lab4_microservices.common.exceptions import UnknownSortStrategyError
...
def build_default_sort_strategy_registry() -> ProductSortStrategyRegistry:
    return ProductSortStrategyRegistry(
        [SortByIdStrategy(), SortByNameStrategy(), SortByPriceStrategy(), SortByTagCountStrategy()]
    )
