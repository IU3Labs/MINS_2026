...
class UnknownSortStrategyError(UserInputError):
    """Указана неизвестная стратегия сортировки."""
...
class CommandHistoryError(WarehouseError):
    """Невозможно выполнить операцию с историей команд."""
