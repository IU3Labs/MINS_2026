...
import main.java.repos.LoanRepository;
...
public class LoanService implements LoanServiceInterface {
    ...
    public void borrowPublication(int pubId, int userId, LocalDate dueDate)
        ...
        Publication pub = publicationRepository.findById(pubId)
                .orElseThrow(() -> new main.java.exceptions.PublicationNotFoundException(pubId));

        if (!pub.isAvailable()) {
            throw new main.java.exceptions.PublicationUnavailableException(pubId);
        }

        User user = userRepository.findById(userId)
                .orElseThrow(() -> new main.java.exceptions.UserNotFoundException(userId));
    ...
    public void returnPublication(int pubId) throws LibrarySystemException {
        ...
        User user = userRepository.findById(loan.getUserId())
                .orElseThrow(() -> new main.java.exceptions.UserNotFoundException(loan.getUserId()));
